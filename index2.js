//* DATA BD
const { getUsuarios, getloginExitoso, getSms } = require('./backend/scriptSQL/Users/Users');
const { crecimiento_servicios } = require('./backend/scriptSQL/comercial/crecimiento_servicios');
const { getProspectos } = require('./backend/scriptSQL/comercial/seguimiento_prospectos');
const { getVacantes } = require('./backend/scriptSQL/rrhh/vacante');
const {getUsuariosRegion} = require('./backend/scriptSQL/rrhh/region');
const {getUsuariosConsulta} = require('./backend/scriptSQL/juridico_normativo/proceso_armado/consulta');
const {getUsuariosInscripcion} = require('./backend/scriptSQL/juridico_normativo/proceso_armado/inscripcion');
const { getUsuariosCredencializacion } = require('./backend/scriptSQL/juridico_normativo/proceso_armado/credencializacion');
const { updateUserStatusByUsername } = require('./backend/scriptSQL/Users/UserBloqueo')
const { insertarAlertaLogin, credencialesFallidas, registroInicioDeSesion, cambioEstatus, verifiacionSms, cambioEstatusSms } = require('./backend/scriptSQL/Users/RegistroLogin')

//*MFA
const { enviarSMS } = require('./backend/twilio/mandarSms');
...
const { insertarDocumento, listarDocumentos, obtenerDocumento,firmaDocumento, UsuariosListar } = require('./backend/scriptSQL/documentos/documentos');
